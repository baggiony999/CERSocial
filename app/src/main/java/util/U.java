...
import com.example.bgm.cersocial.BuildConfig;
import com.example.bgm.cersocial.R;
...
public class U {
    ...
    public static void setTextViewTextWithTS(Activity activity, Object r) {
      //  d("setTextViewTextWithTS="+((TextView) activity.findViewById(R.id.TV01)).getText());
